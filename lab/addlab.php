...
<form method ="POST" action="lab/addlab_confirm.php">
	...
	<div class="card w-75 border-info mb-6" style="margin-right: 10px; ">
		...
		<div class="d-flex flex-row justify-content-between align-content-center card-body text-info" style="padding: 2vw 5vw 0vw 5vw;">
            ...
            <p class="card-text w-50"><input type="text" class="form-control" placeholder="Enter Laboratory Name"  name="labname"></p>
		...
		<input class="btn btn-info btn-md btn-block" type="Submit" name="submit" value="Add Laboratory">
		</div>
	</div>
</form>
